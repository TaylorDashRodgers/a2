...
Part III Questions
a. glm::mat4 transMtx = glm::translate(glm::mat4(1.0f), glm::vec3(x,y,0.0f);
   transMtx = glm::rotate(transMtx, glm::radians(theta), glm::vec3(0.0f,0.0f,1.0f);
   CSCI441::SimpleShader2::pushTransformation(transMtx);
   drawHelmet();
   CSCI441::SimpleShader2::popTransformation();

b. glm::mat4 transMtx = glm::translate(glm::mat4(1.0f), glm::vec3(x,y,0.0f);
   transMtx = glm::translate(transMtx, glm::vec3(i,j,0.0f);
   transMtx = glm::rotate(transMtx, glm::radians(theta), glm::vec3(0.0f,0.0f,1.0f);
   CSCI441::SimpleShader2::pushTransformation(transMtx);
   drawHelmet();
   CSCI441::SimpleShader2::popTransformation();